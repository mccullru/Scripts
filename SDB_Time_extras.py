# -*- coding: utf-8 -*-
"""
Created on Tue Apr 29 16:05:07 2025
...
def extract_raster_values(csv_file, raster_folder, output_folder):
    ...
    # Easting has to be first column, northing has to be second, and ortho heights third
    easting = df.iloc[:, 0]
    northing = df.iloc[:, 1]
    height = df.iloc[:, 2]
...
csv_file = r"B:\Thesis Project\Reference Data\test_topo\calibration_points.csv"      # Calibration reference data
raster_folder = r"E:\Thesis Stuff\pSDB"
output_folder = r"E:\Thesis Stuff\pSDB_ExtractedPts"
...
csv_file = r"B:\Thesis Project\Reference Data\test_topo\validation_points.csv"
