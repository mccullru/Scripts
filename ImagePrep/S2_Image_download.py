...
"""
This code uses an API to download S2 safe files from copernicus sentinel hub. Have to first create a token in 
...
#file_path = r"B:\Thesis Project\Raw Imagery\ImageIDs\Individual_AOI_Lists\Sentinel2\Homer_Alaska_S2.xlsx"
sheet_name = "best"

# Where the files will be saved
download_dir = r"E:\Thesis Stuff\AcoliteWithPython\Uncorrected_Imagery\Homer"
