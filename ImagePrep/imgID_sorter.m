...
Takes the sheets of recorded SuperDove images with the image ID, rating,
descriptor, and best images and creates new columns on the same sheet that 
include totals for the ratings and descriptions
